...
export class LocalStorageContext extends DataContext<
    DocumentTypes,
...
> {
    ...
    contextId() {
        return LocalStorageContext.name;
    }

    computers = this.dbset().default<Computer>(DocumentTypes.Computers).create();
}