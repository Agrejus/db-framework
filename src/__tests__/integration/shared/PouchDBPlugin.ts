...
export class PouchDbPlugin<TDocumentType extends string, TEntityBase extends IDbRecord<TDocumentType>> implements IDbPlugin<TDocumentType, TEntityBase, PouchDB.Find.FindRequest<TEntityBase>, PouchDB.Find.FindResponse<TEntityBase>> {
