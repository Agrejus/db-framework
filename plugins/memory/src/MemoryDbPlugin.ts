...
export class MemoryDbPlugin<TDocumentType extends string, TEntityBase extends MemoryDbRecord<TDocumentType>, TDbPluginOptions extends IDbPluginOptions = IDbPluginOptions> implements IDbPlugin<TDocumentType, TEntityBase> {
